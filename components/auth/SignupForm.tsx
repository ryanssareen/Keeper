  ...
  return (
    <>
      ...
      <label className={`${s.checkboxRow} ${s.agree}`}>
        ...
        <span>
          I agree to Keeper&apos;s <a href="/terms" target="_blank" rel="noreferrer">Terms</a> and{" "}
          <a href="/privacy" target="_blank" rel="noreferrer">Privacy Policy</a>. We only watch the
          trips you ask us to.
        </span>
      </label>
