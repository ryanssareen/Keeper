...
/**
 * POST /api/contact — deliver a contact-form message via Brevo's transactional email REST API.
 *
 ...
 * all user content into the HTML body (no injection), and send. Auth is the v3 API key (xkeysib-…)
 * in the `api-key` header. The sender must be a verified Brevo sender (BREVO_SENDER_EMAIL); replies
 * go to the submitter via replyTo.
 */
